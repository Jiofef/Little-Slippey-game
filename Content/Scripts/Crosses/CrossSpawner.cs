	...
	public override void _PhysicsProcess(double delta)
	{
        ...
        if (G.IsCrossesEnabled)
        {
            ...
            if (_random.Next(RandomRange) == 0)
            {
                ...
                {
                    Cross.Set("position", new Vector2(_player.Position.X + (-750 + _random.Next(1500)) / CrossGathering, _player.Position.Y + (-450 + _random.Next(900)) / CrossGathering));
                    ...
                    switch (Cross.Name)
                    {
                        ...
                        case "BlumCross" or "EnhancedBlumCross":
                            Cross.Set("modulate", new Color(1, 1, 1, 0));
                            if (((Vector2)Cross.Get("position") - _player.Position).X < 300)
                        ...
                        case "EnhancedCannonCross":
                            Cross.Set("position", new Vector2(_random.Next(2) == 0 ? _player.Position.X - 1280 : _player.Position.X + 1280, _player.Position.Y + _random.Next(-750, -250)));
                            break;
                    }
                }
